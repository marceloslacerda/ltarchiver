...
class MyTestCase(unittest.TestCase):
    ...
    def test_create_and_restore_small(self):
        ...
        subprocess.check_call(
            shlex.split(
                f"python3 -m ltarchiver.store {test.TEST_SOURCE_FILE} {TEST_DESTINATION_DIRECTORY}"
            )
        )
        destination_md5 = common.get_file_checksum(TEST_DESTINATION_FILE)
        ...
        recovered_md5 = common.get_file_checksum(TEST_RECOVERY_FILE)
    ...
    def test_restore_small_ecc(self):
        ...
        original_ecc_md5 = common.get_file_checksum(TEST_CHECKSUM_FILE)
        ...
        new_ecc_md5 = common.get_file_checksum(TEST_CHECKSUM_FILE)
    ...
    def test_create_and_restore_large(self):
        make_random_file(test.TEST_SOURCE_FILE, 1024 * 1024)
        original_md5 = common.get_file_checksum(test.TEST_SOURCE_FILE)
        self.assertFalse(TEST_DESTINATION_FILE.exists())
        self.assertFalse(TEST_RECOVERY_FILE.exists())
        subprocess.check_call(
